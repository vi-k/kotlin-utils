...
Результат в итоге будет тот же самый. Отличия лишь в том, что в первом случае проверяется каждый из возможных атрибутов, а во втором случае работа происходит только с атрибутами, реально присутствуюими в HTML-тексте.
